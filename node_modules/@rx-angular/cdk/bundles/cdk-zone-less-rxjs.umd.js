(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@rx-angular/cdk/zone-less/browser'), require('rxjs/operators'), require('@rx-angular/cdk/internals/core')) :
    typeof define === 'function' && define.amd ? define('@rx-angular/cdk/zone-less/rxjs', ['exports', 'rxjs', '@rx-angular/cdk/zone-less/browser', 'rxjs/operators', '@rx-angular/cdk/internals/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['rx-angular'] = global['rx-angular'] || {}, global['rx-angular'].cdk = global['rx-angular'].cdk || {}, global['rx-angular'].cdk['zone-less'] = global['rx-angular'].cdk['zone-less'] || {}, global['rx-angular'].cdk['zone-less'].rxjs = {}), global.rxjs, global['rx-angular'].cdk['zone-less'].browser, global.rxjs.operators, global['rx-angular'].cdk.internals.core));
}(this, (function (exports, rxjs, browser, operators, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var intervalProvider = {
        ...
        setInterval: function (handler, timeout) {
            ...
            return browser.setInterval(handler, timeout);
        },
    ...
    function setupSubscription(sourceObj, eventName, handler, subscriber, options) {
        ...
        if (isEventTarget(sourceObj)) {
            ...
            core.getZoneUnPatchedApi(sourceObj, 'addEventListener').call(sourceObj, eventName, handler, options);
            unsubscribe = function () { return core.getZoneUnPatchedApi(source_1, 'removeEventListener').call(source_1, eventName, handler, options); };
        }
    ...
    var Immediate = {
        setImmediate: function (cb) {
            ...
            if (!resolved) {
                resolved = browser.Promise.resolve();
            }
    ...
    var cancelAnimationFrame = core.getZoneUnPatchedApi('cancelAnimationFrame');
    var requestAnimationFrame = core.getZoneUnPatchedApi('requestAnimationFrame');
    ...
    var AnimationFrameAction = /** @class */ (function (_super) {
        ...
        AnimationFrameAction.prototype.requestAsyncId = function (scheduler, id, delay) {
            ...
            return (scheduler._scheduled ||
                (scheduler._scheduled = animationFrameProvider.requestAnimationFrame(function () { return scheduler.flush(undefined); })));
        };
...
//# sourceMappingURL=cdk-zone-less-rxjs.umd.js.map
