(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@rx-angular/cdk/internals/core')) :
    typeof define === 'function' && define.amd ? define('@rx-angular/cdk/zone-less/browser', ['exports', '@rx-angular/cdk/internals/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['rx-angular'] = global['rx-angular'] || {}, global['rx-angular'].cdk = global['rx-angular'].cdk || {}, global['rx-angular'].cdk['zone-less'] = global['rx-angular'].cdk['zone-less'] || {}, global['rx-angular'].cdk['zone-less'].browser = {}), global['rx-angular'].cdk.internals.core));
    ...
    function queueMicrotask() {
        return core.getZoneUnPatchedApi('queueMicrotask');
    }
    var Promise$1 = core.getZoneUnPatchedApi('Promise');
    /**
    ...
    function requestAnimationFrame(cb) {
        return core.getZoneUnPatchedApi('requestAnimationFrame')(cb);
    }
    /**
    ...
    function setInterval(cb, ms) {
        if (ms === void 0) { ms = 0; }
        return core.getZoneUnPatchedApi('setInterval')(cb, ms);
    }
    /**
     * clearInterval
     *
    ...
    function clearInterval(id) {
        return core.getZoneUnPatchedApi('clearInterval')(id);
    }
    /**
     * setTimeout
     *
    ...
    function setTimeout(cb, ms) {
        if (ms === void 0) { ms = 0; }
        return core.getZoneUnPatchedApi('setTimeout')(cb, ms);
    }
    /**
     * clearTimeout
     *
    ...
    function clearTimeout(id) {
        core.getZoneUnPatchedApi('clearTimeout')(id);
    }
    /**
    ...
    function unpatchAddEventListener(target) {
        target.addEventListener = core.getZoneUnPatchedApi(target, 'addEventListener').bind(target);
        return target;
    }
...
//# sourceMappingURL=cdk-zone-less-browser.umd.js.map
